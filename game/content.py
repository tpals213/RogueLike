...
def make_rogue() -> Character:
    return Character(
        name="도적",
        base_stats=Stats(hp=90, mp=15, atk_phys=16, atk_magic=3, def_phys=6, def_magic=4, crit_chance=0.25, crit_damage=1.6),
...
def make_warrior_stub() -> Character:
    ...
    return Character(
        name="전사",
        base_stats=Stats(hp=120, mp=20, atk_phys=18, atk_magic=4, def_phys=10, def_magic=4, crit_chance=0.1, crit_damage=1.5),
...
def make_mage_stub() -> Character:
    ...
    return Character(
        name="마법사",
        base_stats=Stats(hp=80, mp=40, atk_phys=6, atk_magic=20, def_phys=4, def_magic=8, crit_chance=0.15, crit_damage=1.6),
...
def make_goblin() -> Monster:
    return Monster(
        name="고블린",
        stats=Stats(hp=40, mp=0, atk_phys=8, atk_magic=0, def_phys=3, def_magic=2, crit_chance=0.05, crit_damage=1.5),
...
def make_poison_frog() -> Monster:
    return Monster(
        name="독개구리",
        stats=Stats(hp=32, mp=0, atk_phys=6, atk_magic=0, def_phys=2, def_magic=2, crit_chance=0.05, crit_damage=1.5),
...
def make_orc_warrior() -> Monster:
    return Monster(
        name="오크 전사",
        stats=Stats(hp=110, mp=0, atk_phys=14, atk_magic=0, def_phys=9, def_magic=4, crit_chance=0.08, crit_damage=1.5),
...
def make_ruin_witch() -> Monster:
    return Monster(
        name="폐허의 마녀",
        stats=Stats(hp=85, mp=0, atk_phys=4, atk_magic=18, def_phys=4, def_magic=8, crit_chance=0.12, crit_damage=1.6),
...
def make_forest_guardian() -> Monster:
    return Monster(
        name="숲의 파수꾼",
        stats=Stats(hp=220, mp=0, atk_phys=16, atk_magic=14, def_phys=10, def_magic=8, crit_chance=0.1, crit_damage=1.6),
...
def make_frost_wolf() -> Monster:
    return Monster(
        name="서리 늑대",
        stats=Stats(hp=60, mp=0, atk_phys=13, atk_magic=0, def_phys=5, def_magic=3, crit_chance=0.08, crit_damage=1.5),
...
def make_skeleton_mage() -> Monster:
    return Monster(
        name="스켈레톤 메이지",
        stats=Stats(hp=55, mp=0, atk_phys=0, atk_magic=16, def_phys=3, def_magic=5, crit_chance=0.1, crit_damage=1.6),
...
def make_frost_golem() -> Monster:
    return Monster(
        name="서리 골렘",
        stats=Stats(hp=190, mp=0, atk_phys=18, atk_magic=0, def_phys=15, def_magic=6, crit_chance=0.05, crit_damage=1.5),
...
def make_ice_spirit() -> Monster:
    return Monster(
        name="얼음 정령",
        stats=Stats(hp=140, mp=0, atk_phys=0, atk_magic=24, def_phys=5, def_magic=10, crit_chance=0.12, crit_damage=1.6),
...
def make_frost_queen() -> Monster:
    return Monster(
        name="빙결의 여왕",
        stats=Stats(hp=360, mp=0, atk_phys=18, atk_magic=22, def_phys=12, def_magic=12, crit_chance=0.12, crit_damage=1.6),
...
def make_fire_imp() -> Monster:
    return Monster(
        name="화염 임프",
        stats=Stats(hp=70, mp=0, atk_phys=0, atk_magic=20, def_phys=4, def_magic=6, crit_chance=0.1, crit_damage=1.6),
...
def make_death_knight() -> Monster:
    return Monster(
        name="데스나이트",
        stats=Stats(hp=90, mp=0, atk_phys=22, atk_magic=0, def_phys=9, def_magic=5, crit_chance=0.1, crit_damage=1.6),
...
def make_fire_elemental() -> Monster:
    return Monster(
        name="화염 정령",
        stats=Stats(hp=230, mp=0, atk_phys=0, atk_magic=34, def_phys=8, def_magic=14, crit_chance=0.14, crit_damage=1.6),
...
def make_dark_mage() -> Monster:
    return Monster(
        name="흑마법사",
        stats=Stats(hp=200, mp=0, atk_phys=0, atk_magic=30, def_phys=7, def_magic=12, crit_chance=0.12, crit_damage=1.6),
...
def make_demon_king() -> Monster:
    return Monster(
        name="마왕",
        stats=Stats(hp=550, mp=0, atk_phys=30, atk_magic=30, def_phys=18, def_magic=18, crit_chance=0.15, crit_damage=1.7),
