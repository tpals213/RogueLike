...
# (str) Package name
package.name = roguelite

# (str) Package domain (needed for android/ios packaging)
package.domain = org.jangsemin

# (str) Source code where the main.py live
# main.py는 mobile_build/main.py -> ../mobile_app.py 심볼릭 링크 (repo 루트의 main.py는
# 별개의 전투 로직 스모크 테스트라 이름이 겹쳐서, 빌드 전용 디렉터리를 따로 둔다.
# game/, assets/도 같은 방식으로 심볼릭 링크되어 있다.
